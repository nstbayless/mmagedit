...
00 4A 4A 0A 85 00 C6 00 C6 00 AD C9 05 4A 4A 4A
4A 29 01 05 00 85 02 A9 00 85 03 85 04 A5 BC 0A
0A 85 00 A5 02 4A 4A 4A 4A 29 03 85 04 05 00 0A
A8 B9 60 DC 85 00 B9 61 DC 85 01 05 00 F0 21 20
36 DB C9 FE F0 7C 48 29 E0 AA A5 03 4A 4A 4A 4A
85 05 A5 04 0A 0A 0A 0A 05 05 C5 02 90 47 F0 04
68 4C 28 DC 8A F0 1A C9 E0 F0 42 24 6F 50 06 29
20 D0 37 F0 0C 10 06 29 40 D0 2F F0 04 29 80 D0
29 A5 02 48 0A 0A 0A 0A 85 02 38 A9 F0 E5 02 85
02 A5 03 29 0F 18 65 02 AA 68 85 02 20 36 DB 9D
00 06 4C 13 DC 8A C9 E0 F0 03 20 36 DB 68 29 1F
C9 1D D0 02 A9 41 18 65 03 85 03 90 82 E6 04 4C
A5 DB 68 85 05 68 85 04 68 85 03 68 85 02 68 85
01 68 85 00 68 A8 68 AA A5 D2 29 03 60
	""".strip().replace("\n","  "))),
	
	# after this point come the unitile replacement patches
]

unitile_table_range = [0xDC60, 0xe6c3]
